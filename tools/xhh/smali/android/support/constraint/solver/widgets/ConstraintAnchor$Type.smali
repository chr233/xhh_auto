...
# static fields
.field public static final enum a:Landroid/support/constraint/solver/widgets/ConstraintAnchor$Type;

.field public static final enum b:Landroid/support/constraint/solver/widgets/ConstraintAnchor$Type;

.field public static final enum c:Landroid/support/constraint/solver/widgets/ConstraintAnchor$Type;

.field public static final enum d:Landroid/support/constraint/solver/widgets/ConstraintAnchor$Type;

.field public static final enum e:Landroid/support/constraint/solver/widgets/ConstraintAnchor$Type;

.field public static final enum f:Landroid/support/constraint/solver/widgets/ConstraintAnchor$Type;

.field public static final enum g:Landroid/support/constraint/solver/widgets/ConstraintAnchor$Type;

.field public static final enum h:Landroid/support/constraint/solver/widgets/ConstraintAnchor$Type;

.field public static final enum i:Landroid/support/constraint/solver/widgets/ConstraintAnchor$Type;

.field private static final synthetic j:[Landroid/support/constraint/solver/widgets/ConstraintAnchor$Type;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Landroid/support/constraint/solver/widgets/ConstraintAnchor$Type;->a:Landroid/support/constraint/solver/widgets/ConstraintAnchor$Type;
    ...
    sput-object v0, Landroid/support/constraint/solver/widgets/ConstraintAnchor$Type;->b:Landroid/support/constraint/solver/widgets/ConstraintAnchor$Type;
    ...
    sput-object v0, Landroid/support/constraint/solver/widgets/ConstraintAnchor$Type;->c:Landroid/support/constraint/solver/widgets/ConstraintAnchor$Type;
    ...
    sput-object v0, Landroid/support/constraint/solver/widgets/ConstraintAnchor$Type;->d:Landroid/support/constraint/solver/widgets/ConstraintAnchor$Type;
    ...
    sput-object v0, Landroid/support/constraint/solver/widgets/ConstraintAnchor$Type;->e:Landroid/support/constraint/solver/widgets/ConstraintAnchor$Type;
    ...
    sput-object v0, Landroid/support/constraint/solver/widgets/ConstraintAnchor$Type;->f:Landroid/support/constraint/solver/widgets/ConstraintAnchor$Type;
    ...
    sput-object v0, Landroid/support/constraint/solver/widgets/ConstraintAnchor$Type;->g:Landroid/support/constraint/solver/widgets/ConstraintAnchor$Type;
    ...
    sput-object v0, Landroid/support/constraint/solver/widgets/ConstraintAnchor$Type;->h:Landroid/support/constraint/solver/widgets/ConstraintAnchor$Type;
    ...
    sput-object v0, Landroid/support/constraint/solver/widgets/ConstraintAnchor$Type;->i:Landroid/support/constraint/solver/widgets/ConstraintAnchor$Type;
    ...
    sget-object v2, Landroid/support/constraint/solver/widgets/ConstraintAnchor$Type;->g:Landroid/support/constraint/solver/widgets/ConstraintAnchor$Type;
    ...
    sput-object v0, Landroid/support/constraint/solver/widgets/ConstraintAnchor$Type;->j:[Landroid/support/constraint/solver/widgets/ConstraintAnchor$Type;
...
.method public static values()[Landroid/support/constraint/solver/widgets/ConstraintAnchor$Type;
    ...
    .prologue
    .line 43
    sget-object v0, Landroid/support/constraint/solver/widgets/ConstraintAnchor$Type;->j:[Landroid/support/constraint/solver/widgets/ConstraintAnchor$Type;
